        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_content_creator', models.BooleanField(
                    default=False, verbose_name='Are you a content creator?')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('website_url', models.URLField(blank=True,
                 max_length=255, null=True, verbose_name='Website URL')),
                ('twitter_url', models.URLField(blank=True, max_length=255, null=True, validators=[
                 account.validators.validate_twitter_url], verbose_name='YouTube URL')),
                ('instagram_url', models.URLField(blank=True, max_length=255, null=True, validators=[
                 account.validators.validate_instagram_url], verbose_name='VK URL')),
